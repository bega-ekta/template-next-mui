...
export const lightColors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      menuItemBg: lightThemeColors.white,
      menuItemBgActive: '#f2f5f9',
      menuItemIconColor: lighten(lightThemeColors.secondary, 0.3),
      menuItemIconColorActive: lightThemeColors.primary,
      menuItemHeadingColor: darken(lightThemeColors.secondary, 0.3),
    },
  },
  alpha: {
    white: {
